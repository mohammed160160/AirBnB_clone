...
from models.user import User
    ...
    def test_id_is_match_str(self):
        self.assertEqual(str, type(User().id))

    def test_created_at_is_live_datetime(self):
        self.assertEqual(datetime, type(User().created_at))

    def test_updated_at_is_live_datetime(self):
        self.assertEqual(datetime, type(User().updated_at))

    def test_email_is_valid_str(self):
        self.assertEqual(str, type(User.email))

    def test_password_is_valid_str(self):
        self.assertEqual(str, type(User.password))

    def test_first_name_is_valid_str(self):
        self.assertEqual(str, type(User.first_name))

    def test_last_name_is_valid_str(self):
...
class TestUser_save(unittest.TestCase):
    """Test testing save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        us = User()
        us.middle_name = "Julien"
        us.my_number = 28
        self.assertEqual("Julien", us.middle_name)
